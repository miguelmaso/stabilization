...
\Miguel{
Both unknowns, water depth and flow rate, are continuous at the dry-wet interface, but its derivatives are discontinuous. Even thoug the shock capturing can not avoid this kind of oscilations, it will mitigate them, but the order of accuracy will be lost due to the non-linear artificial diffusion \cite{badia2014}. 
}
