...
\end{equation}
\end{subequations}
where $\mathbf{I}_4$ is the fourth order identity tensor for the stresses\Ignasi{, which is} derived from equation (\ref{stresses}) and will be defined in section \Ignasi{\sout{(}}\ref{sec:fem}\Ignasi{\sout{)}}.
...
\end{equation}%TODO: Ignasi - seguir per aqui
